...
<body>
	<div id="header">
		<div id="wrap-header">
			...
			<div class="center">
				<a href="./index.php"><img src="./images/logoNT.png" alt=""></a>
			</div>
			<div class="right">
				<div class="login">
					<ul>
...
<div class="wrap-menu">	
	<div class="menu">
		<ul class="root">
			...
			<li><a target="_blank" href="http://localhost/b1706838/inc/Gioithieu.html">Thông tin</a></li>
			<li><a href="http://localhost/b1706838/index.php?xem=lienhe">Liên hệ</a></li>
		</ul>
	</div>
</div>
</body>
