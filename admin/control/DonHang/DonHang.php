	...
	<table class="table table-bordered" id="table_List_SP">
		...
		<tbody id="dathang">
			<tr>
				...
				<td><a href="http://localhost/B1706838/admin/trang_admin.php?view=ChiTietDonHang&SoDonDH=<?php echo $row['SoDonDH']?>">Xem</a></td>
...
<?php if(isset($_GET['action'])=='update'&& isset($_GET['SoDonDH'])){
	...
	header("location:http://localhost/B1706838/admin/trang_admin.php?view=DonHang");
} ?>
<style>
	#dathang{
		text-align: center;
