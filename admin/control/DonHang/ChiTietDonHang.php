<div class="col-sm-9" id="content" >
	...
	<table class="table table-bordered" id="table_List_SP">
		...
		<tbody id="chitietdathang">
			<tr>
				...
				<td><img style="width: 25%;" src="http://localhost/B1706838/images/SanPham/<?php echo $row['Hinh'] ?>" ></td>
    ...
    margin-bottom: 10px;" name="" class="btn btn-secondary">Xác nhận đơn hàng</button>
	</a>
